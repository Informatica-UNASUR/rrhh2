...
if($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $fpdf->Cell(0, 5, 'LISTADO DE EMPLEADOS POR CARGO Y DEPTO.', 0, 0, 'C');
        $fpdf->Ln(15);
        ...
        $fpdf->Cell(80, 7, 'EMPLEADO', 0, 0, 'L');
        $fpdf->Cell(60, 7, 'CARGO', 0, 0, 'L');
        $fpdf->Cell(14, 7, 'SALARIO', 0, 0, 'R');
...
//die();
        foreach ($empleados as $empleado) {
            ...
            $fpdf->Cell(80, 7, $empleado['nombre'] . ' ' . $empleado['apellido'], 0, 0, 'L');
            $fpdf->Cell(60, 7, $empleado['nombreCargo'], 0, 0, 'L');
            $fpdf->Cell(14, 7, number_format($empleado['salarioFijo'], 0, '.', '.'), 0, 0, 'R');
            $fpdf->Ln();
        };
